...
- **gpt-4o quota.** The deployment is small (Standard 50 TPM). Rapid back-to-back turns can 429 the shared deployment — which degrades to the verified deterministic summary, never an error. A real demo (one call per turn) is comfortable.
